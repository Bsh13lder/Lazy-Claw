...
/// [detectAutoLink]) lives in `univer_links.dart` (UniverLinks extension).
///
...
// ── Hyperlink plugin constant (used by structural ops link-shift helpers) ─────
...
/// Extension methods that add structural ops, sort, freeze and TSV onto
/// [UniverSheet]. Kept separate from [UniverSheetModel] to stay under the
/// 800-line file limit.
extension UniverOps on UniverSheet {
  ...
  // ─── Link CRUD helpers (used by structural ops: insert/delete/sort/clear) ────
