...
from mcp_scraper._vendor.crawl4ai.extraction_strategy import ExtractionStrategy
...
def create_extraction_strategy(
    ...
    if strategy_type == "css":
        ...
        from mcp_scraper._vendor.crawl4ai.extraction_strategy import LLMExtractionStrategy
