...
def _today_iso() -> str:
    """Local-time ISO date. Journal pages follow the user's calendar, not UTC."""
...
def resolve_date(value: str | None) -> str:
    ...
    if value.lower() == "yesterday":
        return (date.fromisoformat(_today_iso()) - timedelta(days=1)).isoformat()
