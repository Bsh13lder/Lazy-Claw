"""Security manager for computer control.

Command blocklists, path blocklists, and validation for all execution paths.
Extracted from LazyTasker connector/security.py.
"""
...
class SecurityManager:
    """Immutable security validator for computer commands and file paths."""
